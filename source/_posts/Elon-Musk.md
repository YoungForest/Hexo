...
categories:
- 读后感
description: "读完《埃隆·马斯克传》后的复杂感受：既被火箭与电动车创业史鼓舞，也警惕极端降本、快速试错和员工代价。"
translations:
...
<figure class="editorial-illustration editorial-illustration--hero">
  <img src="/images/ai/Elon-Musk/zh-hero.webp" alt="一条从车库、支付管道、火箭试验架、电动车装配线延伸到星海的高风险工业轨道围绕一张空工作台快速运转" width="1536" height="864" decoding="async" fetchpriority="high">
</figure>
...
<figure class="editorial-illustration">
  <img src="/images/ai/Elon-Musk/zh-delete-loop.webp" alt="巨大的修枝剪不断从抽象机器上剪去螺栓和备件，旁边的试验架反复接住失败零件并把必要部分送回" width="1536" height="864" loading="lazy" decoding="async">
</figure>
